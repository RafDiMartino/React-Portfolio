        ...
        <div className='social-container'>
            <div className='social-media-wrapper'>
                <a href="mailto:r.dimartino.uk@gmail.com" target="_blank" rel="noopener noreferrer" aria-label="link to the email">
                    <svg fill="var(--white)" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24">
            ...
            <a className='button cv-button' href={CV} target="_blank" rel="noreferrer">Download my CV</a>
        </div>
